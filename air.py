...
icon = Image.open("D:/program session/project/Airbnb/logo.png")
...
with st.sidebar:
    selected = option_menu("Menu", ["Home", "Overview", "Explore","Contact"],
                           icons=["house", "graph-up-arrow", "bar-chart-line","at"],
...
client = pymongo.MongoClient("mongodb+srv://krtk613001:karthik29@cluster0.197uwrv.mongodb.net/?retryWrites=true&w=majority")
db = client.sample_airbnb
col = db.listingsAndReviews

# READING THE CLEANED DATAFRAME
df = pd.read_csv('C:/Users/INFOFIX_COMPUTERS/project 1/Airbnb_data.csv')

# HOME PAGE
if selected == "Home":
    # Title Image
    st.image("D:/program session/project/Airbnb/airbnb_logo.jpg")
    st.video("D:/program session/project/Airbnb/airbnb.MP4")
    ...
    col2.markdown("#   ")
    col2.markdown("#   ")
    col2.image("D:/program session/project/Airbnb/airbnb_logo.jpg",width=350)
...
if selected == "Contact":
    ...
    st.image(Image.open("C:/Users/INFOFIX_COMPUTERS/OneDrive/Desktop/Phonepe/photo/my.jpg"), width=350)
    st.subheader(mail)
    st.write("#")
