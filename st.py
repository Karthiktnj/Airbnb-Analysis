...
myclient=MongoClient('mongodb+srv://krtk613001:karthik29@cluster0.197uwrv.mongodb.net/?retryWrites=true&w=majority')
...
if st.button('Dynamic Visualistion'):
    ...
    mycursor = db.cursor()
    engine = create_engine('mysql+mysqlconnector://root:Karthik29@@localhost/airbnb_2', echo=False)
